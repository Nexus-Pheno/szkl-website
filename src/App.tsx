...
function getInitialLanguage(): Language {
  ...
  return window.localStorage.getItem('szkl-language') === 'zh' ? 'zh' : 'en';
}
...
function App() {
  ...
  const shouldRenderHeroVideo = isDesktop && !shouldReduceMotion;
  ...
  useMotionValueEvent(scrollYProgress, 'change', (latest) => {
    const shouldShow = latest > 0 && window.scrollY >= window.innerHeight * 0.9;
    ...
    if (scrollFrameRef.current === null) {
      scrollFrameRef.current = window.requestAnimationFrame(() => {
        ...
        if (surface) {
          setBackToTopSurface((current) => (current === surface ? current : surface));
        }
      });
    }
  });
  ...
  const changeLanguage = useCallback((nextLanguage: Language) => {
    ...
    if (nextLanguage === 'zh') {
      nextUrl.searchParams.set('lang', 'zh');
    } else {
  ...
  return (
    <>
      <a
        href="#main-content"
        className="fixed left-4 top-4 z-[110] -translate-y-24 rounded-full bg-white px-5 py-3 text-sm font-medium text-black shadow-xl transition-transform focus:translate-y-0"
      >
        {copy.skipToContent}
      </a>
      <main
        id="main-content"
        tabIndex={-1}
        className="min-w-0 overflow-hidden bg-[#f2f1ec] text-[#111]"
      >
        <motion.div
        ...
        <section
          id="home"
          data-surface="dark"
          className="hero-stage relative min-h-[100svh] scroll-mt-0 overflow-hidden bg-black text-white"
        >
            ...
            >
              <div className="min-w-0">
                ...
                <FadeUp
                  ...
                  delay={0.16}
                  y={28}
                  className="mt-7 max-w-3xl text-[clamp(1.05rem,2.2vw,1.5rem)] leading-[1.42] text-white/[0.72]"
                >
              ...
              <FadeUp
                delay={0.22}
                className="min-w-0 rounded-[1.75rem] border border-white/[0.18] bg-black/30 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.32)] backdrop-blur-xl lg:mb-1"
              >
                <div
                ...
                <p className="text-base leading-relaxed text-white/[0.78]">{copy.hero.body}</p>
                <div className="mt-7 flex flex-col gap-3">
                  ...
                  <a
                    href="#about"
                    className="group flex items-center justify-between rounded-full border border-white/[0.18] px-5 py-3.5 text-sm text-white/70 transition-colors duration-300 hover:border-white/40 hover:text-white"
                  >
                    {copy.hero.explore}
                    <ArrowDown
          ...
          {shouldRenderHeroVideo && (
            <button
              type="button"
              className="absolute bottom-5 right-5 z-20 grid h-11 w-11 place-items-center rounded-full border border-white/30 bg-black/40 text-white shadow-lg backdrop-blur-md transition-colors hover:border-white/60 hover:bg-black/60 sm:bottom-7 sm:right-8"
              onClick={toggleHeroVideo}
              aria-label={videoPaused ? copy.hero.playVideo : copy.hero.pauseVideo}
              title={videoPaused ? copy.hero.playVideo : copy.hero.pauseVideo}
            >
              {videoPaused ? (
        ...
        <section
          id="about"
          data-surface="light"
          className="relative scroll-mt-0 overflow-hidden px-5 py-20 sm:px-8 sm:py-32 lg:px-10 lg:py-40"
        >
          <motion.div
          ...
          <div className="relative z-10 mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.31fr_minmax(0,1fr)] lg:gap-20">
            <div>
              ...
              <FadeUp
                as="p"
                delay={0.08}
                className="mt-7 max-w-xs text-sm leading-relaxed text-black/60"
              >
                {copy.about.intro}
              </FadeUp>
            </div>
            <div className="min-w-0">
              <FadeUp
                ...
                y={30}
                mobileX={14}
                className="max-w-5xl text-4xl font-medium leading-[1.02] tracking-[-0.048em] sm:text-6xl lg:text-7xl"
              >
                {copy.about.title}
              </FadeUp>
              <div className="mt-12 grid gap-8 border-t border-black/20 pt-8 md:grid-cols-2">
                <FadeUp
                  as="p"
                  delay={0.08}
                  className="max-w-xl text-base leading-relaxed text-black/60 sm:text-lg"
                >
                  {copy.about.mission}
                </FadeUp>
                <FadeUp
                  as="p"
                  delay={0.14}
                  className="max-w-md text-sm leading-relaxed text-black/60 md:justify-self-end"
                >
                  {copy.about.belief}
                </FadeUp>
              </div>
        ...
        <section
          id="ecosystem"
          data-surface="dark"
          className="scroll-mt-0 bg-[#090909] px-5 py-20 text-white sm:px-8 sm:py-32 lg:px-10 lg:py-36"
        >
          <div className="mx-auto max-w-7xl">
            <div className="grid min-w-0 gap-8 lg:grid-cols-2 lg:items-end">
              ...
              <FadeUp
                as="h2"
                y={30}
                className="max-w-2xl text-4xl font-medium leading-[0.98] tracking-[-0.045em] sm:text-6xl lg:justify-self-end"
              >
            ...
            <div className="mt-16 grid min-w-0 gap-3 lg:grid-cols-3">
              ...
              >
                <motion.article
                  className="ecosystem-card ecosystem-card-company grid h-full min-h-[440px] min-w-0 grid-rows-[auto_112px_minmax(0,1fr)_auto] gap-y-6 rounded-[2rem] border border-white/[0.14] bg-black p-7 sm:p-9"
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-4 text-xs uppercase tracking-[0.18em] text-white/60">
                    <span>01</span>
                  ...
                  <a
                    href="#about"
                    className="group inline-flex min-h-11 w-fit items-center gap-3 rounded-full border border-white/[0.22] px-5 py-3 text-sm font-medium text-white/[0.78] transition-colors hover:border-white/45 hover:text-white"
                  >
              ...
              >
                ...
                >
                  <span className="ecosystem-card-sheen" aria-hidden="true" />
                  <div className="flex items-center justify-between gap-4 text-xs uppercase tracking-[0.18em] text-black/60">
                    <span>03</span>
                    <span className="inline-flex items-center gap-2">
                      <LockKeyhole className="h-3.5 w-3.5" aria-hidden="true" />{' '}
                      {copy.ecosystem.phenoLabel}
                    </span>
                  </div>
                  <div className="flex min-w-0 items-center">
                    <img
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group inline-flex min-h-11 w-fit items-center gap-3 rounded-full border border-black/[0.22] px-5 py-3 text-sm font-medium text-black transition-colors hover:border-black/55"
                  >
        ...
        >
          <motion.div
            className="ambient-orb pointer-events-none absolute -left-52 top-24 h-[560px] w-[560px] rounded-full bg-[#8290ff]/[0.09] blur-[115px]"
            ...
            <div className="grid min-w-0 gap-10 lg:grid-cols-[0.55fr_minmax(0,1fr)] lg:gap-20">
              <div>
                ...
                <FadeUp
                  as="h2"
                  y={30}
                  className="mt-6 max-w-xl text-[clamp(2.65rem,13vw,3rem)] font-medium leading-[0.96] tracking-[-0.05em] sm:text-7xl"
                >
                  {copy.culture.title}
                </FadeUp>
              </div>
              <FadeUp
                as="p"
                delay={0.08}
                className="max-w-2xl text-lg leading-relaxed text-black/60 lg:pt-10"
              >
                {copy.culture.intro}
              </FadeUp>
            </div>
            ...
            <div className="mt-16 grid min-w-0 gap-x-8 sm:grid-cols-2 lg:grid-cols-4">
              {copy.culture.values.map((value, index) => (
                <FadeUp
                  ...
                  className="relative min-w-0 border-t border-black/15 py-7 sm:py-8 lg:min-h-[230px]"
                >
                  <motion.span
                  ...
                  <h3 className="mt-6 text-xl font-medium tracking-[-0.025em] sm:mt-9">
                    {value.title}
                  </h3>
                  <p className="mt-4 text-sm leading-relaxed text-black/60">{value.body}</p>
                </FadeUp>
              ))}
            </div>
          </div>
        ...
        <section
          id="pulse"
          data-surface="dark"
          className="relative scroll-mt-0 overflow-hidden bg-[#111318] px-5 py-20 text-white sm:px-8 sm:py-32 lg:px-10 lg:py-40"
        >
          <motion.div
            className="ambient-orb pointer-events-none absolute -right-48 top-20 h-[680px] w-[680px] rounded-full bg-[#4d5bff]/[0.18] blur-[120px]"
          ...
          <div className="relative mx-auto grid max-w-7xl min-w-0 gap-16 lg:grid-cols-[minmax(0,1.5fr)_minmax(280px,0.5fr)] lg:gap-16">
            <div className="min-w-0">
              ...
              <FadeUp
                as="p"
                className="text-xs font-semibold uppercase tracking-[0.28em] text-[#aab3ff]"
              >
                {copy.pulse.label}
              </FadeUp>
              <FadeUp
                as="h2"
                y={30}
                className="mt-6 max-w-5xl text-[clamp(2.65rem,13vw,3rem)] font-medium leading-[0.92] tracking-[-0.055em] sm:text-7xl"
              >
                {copy.pulse.title}
              </FadeUp>
              <FadeUp
                as="p"
                delay={0.1}
                className="mt-10 max-w-3xl text-base leading-relaxed text-white/[0.62] sm:text-lg sm:leading-relaxed"
              >
                {copy.pulse.intro}
              </FadeUp>
              <FadeUp delay={0.16}>
            ...
            <div className="min-w-0 border-t border-white/20">
              {copy.pulse.directions.map((item, index) => (
                <FadeUp
                  ...
                  className="grid min-w-0 grid-cols-[42px_minmax(0,1fr)] gap-5 border-b border-white/15 py-7"
                >
        ...
        <section
          data-surface="light"
          className="bg-white px-5 py-20 sm:px-8 sm:py-32 lg:px-10 lg:py-36"
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex min-w-0 items-end justify-between gap-8">
              <div className="min-w-0">
                ...
                <FadeUp
                  ...
                  y={30}
                  className="mt-5 max-w-3xl text-4xl font-medium leading-[1] tracking-[-0.045em] sm:text-6xl"
                >
                  {copy.learning.title}
                </FadeUp>
              </div>
              <ArrowDownRight
                className="hidden h-12 w-12 shrink-0 text-black/25 sm:block"
                aria-hidden="true"
              />
            </div>
            ...
            <div className="relative mt-16 grid min-w-0 border-t border-black/20 md:grid-cols-2 lg:grid-cols-5">
              ...
              {copy.learning.steps.map((step, index) => (
                ...
                >
                  <span className="inline-flex items-center gap-3 text-xs text-black/60">
                    <motion.span
                  ...
                  <h3 className="mt-8 text-2xl font-medium tracking-[-0.03em] sm:mt-10 md:mt-14">
                    {step.title}
                  </h3>
                  <p className="mt-4 max-w-[180px] text-sm leading-relaxed text-black/60">
                    {step.body}
                  </p>
                </FadeUp>
              ))}
        ...
        <section
          id="contact"
          data-surface="dark"
          className="closing-stage relative scroll-mt-0 overflow-hidden bg-black px-5 pb-8 pt-20 text-white sm:px-8 sm:pt-32 lg:px-10 lg:pt-40"
        >
          <motion.div
            className="pointer-events-none absolute -left-44 top-20 h-[560px] w-[560px] rounded-full bg-[#5967ff]/[0.18] blur-[120px]"
          ...
          <div className="relative z-10 mx-auto max-w-7xl">
            ...
            <FadeUp
              ...
              y={30}
              mobileX={-14}
              className="mt-6 max-w-6xl text-[clamp(2.65rem,12.8vw,3rem)] font-medium leading-[0.9] tracking-[-0.055em] sm:text-7xl lg:text-8xl"
            >
              {copy.closing.title}
            </FadeUp>
            <div className="mt-12 flex flex-col gap-4 sm:flex-row">
              ...
              <FadeUp delay={0.16}>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center gap-3 rounded-full border border-white/20 px-6 py-4 text-sm text-white/[0.68] transition-colors hover:border-white/40 hover:text-white"
                >
            ...
            <footer className="mt-24 grid gap-6 border-t border-white/15 py-8 text-xs text-white/60 sm:mt-32 sm:grid-cols-3 sm:items-center">
